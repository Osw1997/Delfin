...
// Nuevos
double EMO_Indicator_m1(double *f, int *filter, int n, double *pf, int m, int dim);
double EMO_Indicator_gd_plus(double *f, int *filter, int n, double *pf, int m, int dim, double p);
double EMO_Indicator_deltap_plus(double *f, int *filter, int n, double *pf, int m, int dim, double p);
double EMO_Indicator_igd_ns(double *f, int *filter, int n, double *pf, int m, int dim);
int sigma(double *v, char **str, int nrun, int argc, char **argv);
double EMO_Indicator_sigma_tau_kappa(double *set1, double *set2, int rows_a, int cols_a, int rows_b, int cols_b, char *type);
int objigd(double *v, char **str, int nrun, int argc, char **argv);
double EMO_Indicator_objigd(double *data, int row, double *ref, int row2, int col);
